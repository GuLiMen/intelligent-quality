...
public class TimeUtils {
    ...
    public static void main(String args[]) throws ParseException {
        String str_begin = "2020-12-13 13:29:56.867000000";
        String str_end = "2020-12-28 13:29:56.867000000";
        getWeeks(str_begin, str_end);
...
//        System.out.println(getMonths(str_begin, str_end) );
    ...
    public static Map<String, String> getQuarter(String begins, String ends) {
        ...
        while (true) {
            ...
            String str_begin = sdf.format(cal_begin.getTime());
            String str_end = getMonthEnd(cal_end.getTime());
    ...
    public static Map<String, String> getMonths(String begins, String ends) {
        ...
        cal_end.setTime(end);
        while (true) {
            if (cal_begin.get(Calendar.YEAR) == cal_end.get(Calendar.YEAR) && cal_begin.get(Calendar.MONTH) ==
    ...
    // 将时间按照星期分割
    public static Map<String,String> getWeeks(String startDate, String endDate) throws ParseException {
        Map<String, String> map = new LinkedHashMap<String, String>();
...
//            resultlist.add(time);
    ...
    public static Map<String,String> getWeekDeprecate(String begins, String ends) throws ParseException {
