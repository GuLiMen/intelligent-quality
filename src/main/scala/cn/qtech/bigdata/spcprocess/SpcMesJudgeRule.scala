...
object SpcMesJudgeRule {
  ...
  def judgeRule(sparkSession: SparkSession, sc: SparkContext, kuduMaster: String, spcclresultlist: String,
                spcpointlist: String, insertTable: String): Unit = {
      ...
      if (integer.get() == numfield.toInt) {
        ...
        groupDataList.foreach (item => {
          ...
          val numPoint = pointArrs {23}.toInt;
            ...
            if (avgValue != "" && rangeValue != "" && pcs == 1) {
            ...
            } else if (avgValue != "" && rangeValue != "" && pcs >= 2 && pcs <= 5) {
              ...
              if (numPoint >= 5) {
                ...
                // 1.判断均值
                val rulename1 = "均值三"
                judgeSpc3Rule(spc8RuleList, avgrule3datalist, groupDataList, avgUcl, avgLcl, avgValue, rulename1,
                  numPoint)
                // 2.判断极差
                val rulename2 = "极差三"
                judgeSpc3Rule(spc8RuleList, rangerule3datalist, groupDataList, rangeUcl, rangeLcl, rangeValue, rulename2,
            ...
            } else if (avgValue != "" && stddevValue != "" && pcs >= 6) {
              ...
              if (numPoint >= 5) {
                ...
                // 2.判断标准差
                val rulename2 = "标准差三"
                judgeSpc3Rule(spc8RuleList, stddevrule3datalist, groupDataList, stddevUcl, stddevLcl, stddevValue,
                  rulename2, numPoint)
              }*/
